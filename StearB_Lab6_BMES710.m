...
% Ben Stear
% BMES 710
% Lab 6: Entropy and Mutual Information
% 3/6/18
...
% a.) COUNT ENTROPYs: Ec_1 = 2.4420,  Ec_2 = 1.6366,  Ec_3 = 1.2893,  Ec_4 = 2.2092
...
% TIMING ENTROPYs Et_1 = 3.0194  Et_2 = 2.3537  Et_3 = 1.9644 Et_4 = 2.1310

Ps = 0.5; % P[s] = 0.5

% c.  I think the relationship between the count entropy and the timing
% entropy for the same neuron for the same stimulus is inversely related.
% For example if a neuron has really high count entropy (or uncertainty) for a
% particular stimulus than that neuron will have low timing entropy for
% that same stimulus.
...
% a) I think that neuron2 conveyed more information because its response
% varied from stim1 to stim2. Neuron1 reacted the same way to both
% stimulations so its hard to say if there was any meaningful info
% conveyed.
...
uniqueCounts1 = [7 1 10 9 2 1 14 14 7 10 12 5 5 6 5 1 2 2 1 1 1];
uniqueCounts2 = [28 17 10 5 3 1 1 12 4 7 4 3 7 4 1 3 1 1 2 1 1];
...
% d) Not sure.
% e) didnt get here
% f) I believe the neurons are synergistic.
